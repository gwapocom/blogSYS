...
<?php 
   ...
   while ($DataRows = $stmt->fetch()) {
      ...
      $PostTextToDelete = $DataRows["post"];
   }
   /* echo $ImageToUpdate; */
if(isset($_POST['Submit'])){
   //Query to DELETE Post in DB when fine 
       global $ConnectingDB;
       $sql = "DELETE FROM posts WHERE id='$SearchQueryParameter'";
       $Execute = $ConnectingDB->query($sql);
      if($Execute) {
         $Target_Path_To_DELETE_IMG = "uploads/$ImageToDelete";
               ...
               <div class="card bg-secondary text-light mb-3">
                  <div class="card-body bg-dark">
                     <div class="form-group">
                        ...
                        <input disabled class="form-control" type="text" name="postitle" id="title" placeholder="Type title here" value="<?php echo $TitleToDelete; ?>">
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <img class="mb-2" src="uploads/<?php echo $ImageToDelete; ?>" width="170px"; height="70px"; alt="">
                     </div>

                     <div class="form-group">
                        <label for="post"> <span class="FieldInfo"> Post: </span></label>
                        <textarea disabled id="post" class="form-control" name="postdescription" cols="80" rows="8">
                           <?php echo $PostTextToDelete; ?>
                        </textarea>
                     </div>
