...
if(empty($PostTitle)) {
   ...
   $_SESSION['ErrorMessage'] = "Post title should be greater than 5 characters";
    ...
    Redirect_to("addnewpost.php");   
       ...
       //Query to insert Post in DB when fine 
       $sql = "INSERT INTO posts(datetime,title,category,author,image,post)";
       $sql .="VALUES(:datetime,:posTitle,:categoryName,:admiName,:imageName,:postDesc)";
      $stmt = $ConnectingDB->prepare($sql);
      $stmt->bindValue(':datetime',$DateTime);
      $stmt->bindValue(':posTitle',$PostTitle);
      $stmt->bindValue(':categoryName',$Category);
      $stmt->bindValue(':admiName',$Admin);
      $stmt->bindValue(':imageName',$Image);
      $stmt->bindValue(':postDesc',$PostText);
               ...
               <div class="card bg-secondary text-light mb-3">
                  <div class="card-body bg-dark">
                     <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="postitle" id="title" placeholder="Type title here" value="">
                     </div>
                     ...
                     <div class="form-group">
                        ...
                        <textarea id="post" class="form-control" name="postdescription" cols="80" rows="8"></textarea>
                     </div>
                     <div class="row">
